            ...
            return (
              ...
              >
                ...
                <div className="text-gray-600 text-sm">
                  {step.number === "06" &&
                  step.title === "Features and Functionality" &&
                  (!step.description || step.description.trim() === "") ? (
                    <div>
                      <p className="mb-4 font-medium">
                        The features and functionality section includes several
                        key components that enhance user experience and business
                        operations.
                      </p>

                      <div className="space-y-3">
                        <div className="flex items-start">
                          <span className="text-customYellow mr-3 mt-1 text-lg">
                            ❖
                          </span>
                          <div>
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <span className="ml-1">
                              – Clear breakdown of diagnostics, engine repairs,
                              fleet servicing and transport solutions.
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <span className="ml-1">
                              – Dedicated page showcasing available vehicles for
                              sale, complete with specifications, pricing, and
                              images. Helps potential customers browse inventory
                              directly on-site and acts as a powerful lead
                              generator for sales inquiries.
                            </span>
                          </div>
                        </div>
                          ...
                          <div>
                            ...
                            <div className="ml-1 mt-2 space-y-2">
                              <div>
                                ...
                                <span className="ml-1">
                                  The page offers a diverse inventory of spare
                                  parts, including engine components, suspension
                                  systems, electrical parts, and more, ensuring
                                  that customers can find the exact parts they
                                  need for various vehicle repairs and upgrades.
                                </span>
                              </div>
                              <div>
                                <span className="font-medium text-gray-700">
                              ...
                              <div>
                                ...
                                <span className="ml-1">
                                  As a New Zealand-based business, Kandy
                                  Mechanical offers local knowledge and support,
                                  ensuring that customers receive parts that are
                                  suitable for local vehicles and driving
                                  conditions.
                                </span>
                              </div>
                            </div>
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <span className="ml-1">
                              – Easy-to-use inquiry form with integrated email
                              notifications.
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <span className="ml-1">
                              – The website showcases positive feedback from
                              customers to reinforce their reputation.
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <span className="ml-1">
                              – Embedded Google Map to help clients easily
                              locate the Hamilton workshop.
                            </span>
                          </div>
                        </div>
                      </div>
                    ...
                    (step.description.includes("Section") ||
                      step.description.includes("Page") ||
                      step.description.includes("Form")) ? (
                    <div>
                      ...
                      {(() => {
                        ...
                        const sectionMatches =
                          remainingText.match(
                            /The [A-Z][^.]*?(?:Section|Page|Form|Map)[^.]*?\./g
                          ) || [];

                        sectionMatches.forEach((match) => {
                          const titleMatch = match.match(
                            /The ([^–]+?)(?:\s+–|\s+provides|\s+offers|\s+features|\s+with|\s+includes)/i
                          );
                          if (titleMatch) {
                        ...
                        if (sections.length === 0) {
                          const parts = remainingText.split(
                            /(?=\s[A-Z][a-z]+\s(?:Section|Page|Form|Features?))/
                          );
                          parts.forEach((part) => {
                            const trimmed = part.trim();
                            if (trimmed) {
                              const firstSentence = trimmed.split(".")[0];
                              const title = firstSentence.split(
                                /\s+(?:highlights|provides|offers|features|includes)/i
                              )[0];
                              sections.push({
                            ...
                            {sections.length > 0
                              ? sections.map((section, idx) => (
                                  <div key={idx} className="mb-3 pl-4">
                                    <div className="flex items-start">
                                      <span className="text-customYellow mr-2 mt-1 text-lg">
                                        •
                                      </span>
                                      <div>
                                ...
                                remainingText
                                  ...
                                  .map((part, idx) => (
                                    <div key={idx} className="mb-2 pl-4">
                                      <div className="flex items-start">
                                        <span className="text-customYellow mr-2 mt-1">
                                          •
                                        </span>
